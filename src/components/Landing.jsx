...
const Landing = ({setSelectedPage}) => {
    ...
    return (
        <section id="home" className="gap-16 py-10 md:flex md:justify-between md:items-center md:h-full h-[3000px]">
            ...
            <div className='z-30 basis-2/5 mt-12 md:mt-32'>
                <motion.div
                    ...
                    >
                        <p className='text-6xl font-playfair z-10 text-center md:text-start'>Bùi Ngọc 
                            ...
                            before:-top-[70px] before:z-[-1] before:opacity-90'> Cường</span>
                        </p>
